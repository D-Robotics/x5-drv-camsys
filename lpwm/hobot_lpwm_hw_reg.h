...
/* lpwm config range */
#define LPWM_OFFSET_MAX		1000000U
#define LPWM_PERIOD_MIN		1
#define LPWM_PERIOD_MAX		1000000U
#define LPWM_HIGH_MAX		4000U
#define LPWM_HIGH_MIN		0
#define LPWM_THRESHOLD_MAX	0xFFFF
#define LPWM_STEP_MAX		0xF
#define LPWM_OFFSET_MASK		0xFFFFF
#define LPWM_PERIOD_MASK		0xFFFFF
#define LPWM_HIGH_MASK			0xFFF
